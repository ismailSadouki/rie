...
- <mark>`LinearRegression` in scikit-learn **does not require standardization** and may even perform **better without it**, especially in terms of interpretability.</mark>
    
- <mark>However, **for regularized models or SGD-based models**, standardization is generally **essential**.</mark>
```
