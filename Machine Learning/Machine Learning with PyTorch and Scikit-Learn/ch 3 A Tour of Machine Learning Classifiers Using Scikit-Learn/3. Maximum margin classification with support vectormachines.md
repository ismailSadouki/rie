...
The use of the slack variable, in turn, introduces the variable, which is commonly referred to as C in SVM contexts. <mark>We can consider C as a hyperparameter for controlling the penalty for misclassification</mark>.
