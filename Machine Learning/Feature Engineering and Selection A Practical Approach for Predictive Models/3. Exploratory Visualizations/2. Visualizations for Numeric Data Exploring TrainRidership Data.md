...
# 2.6 | Line Plots
We can assess the relationship between time and the value of a variable by creating a line plot. Identifying time trends can lead to other features or to engineering other features that are associated with the response.
